...
- **추천 이유(reason) 톤 가이드**:
  - 친근하지만 예의 있는 톤. 짧고 구체적으로.
  - **1문장, 20~30자.** ~해요/~이에요 해요체 사용. 딱딱한 격식체(~합니다/~입니다) 대신 자연스러운 존댓말.
  - DO: "보면 잠 못 자요", "배우 연기가 정말 좋아요", "반전이 세 번은 나와요", "첫 회 끝나면 바로 다음 회 틀게 돼요", "우울할 때 보면 치유돼요", "중반부터 숨 못 쉬어요", "OST가 너무 좋아요"
