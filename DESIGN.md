...
- **Saved:** 3열 비대칭 그리드 (Pinterest식, 2026-07 3열 전환 — 누적 저장작 밀도 대응). 포스터 2:3 비율 + 높이 변화 유지. 단조로운 균일 그리드 금지.
...
- **Saved:** 3열 비대칭 (포스터 2:3 비율 연동, 높이 변화: `CARD_H = CARD_W×1.5` / tall `×1.6`). Pinterest식 비대칭 보존. 2026-07 2열→3열 전환.
