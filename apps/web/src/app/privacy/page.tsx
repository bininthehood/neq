...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-12 text-[15px] leading-7 text-neutral-100">
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">4. 제3자 서비스</h2>
        <p className="mb-3 text-neutral-300">
          neq 는 아래 서비스를 통해 데이터를 처리해요. 각 서비스는 자체
          개인정보처리방침을 따라요.
        </p>
        <ul className="ml-4 list-disc space-y-2 text-neutral-300">
          ...
          <li>
            ...
            요청 시 사용자 취향 요약과 후보 작품 목록만 전송. 익명 식별자는 보내지
            않아요.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">5. 데이터 보존 기간</h2>
        <ul className="ml-4 list-disc space-y-1 text-neutral-300">
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">6. 사용자 권리</h2>
        <p className="mb-3 text-neutral-300">
        ...
        <p className="mt-3 text-neutral-300">
          ...
          ID 를 알려주세요. 30일 이내 처리해요.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">7. 어린이 보호</h2>
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">8. 보안</h2>
        <p className="text-neutral-300">
          모든 데이터 전송은 HTTPS 로 암호화돼요. Supabase 의 익명 사용자 데이터는
          Row Level Security (RLS) 로 디바이스 단위 격리해요. 그럼에도 인터넷 전송의
          완전한 보안은 보장할 수 없어요.
        </p>
      </section>
